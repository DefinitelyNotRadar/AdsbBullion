...
namespace ConsoleApp1
{
    internal class Program
    {
        ...
        private static void ProcessPacket(object sender, List<PlaneData> e)
        {
            ...
            e.ForEach(p => Console.WriteLine("Icao: " + p.Icao + " AirId: " + p.AirId + " Lat: " + p.Lat + " Long: " + p.Long + " Height: " + p.Altitude + " Velocity: " + p.AirSpeed + " AirCat: " + p.AirCat + " Track angle: " + p.TrackAngle + " Ground speed:" + p.GroundSpeed));            
            Console.WriteLine("---------------------------------------------------------------------------------------------------------");
