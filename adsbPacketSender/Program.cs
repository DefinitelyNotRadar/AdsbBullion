            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    while (!Console.KeyAvailable)
                    {
                        ...
                        byte[] bytestosendDF17TypeCode19ST1 = new byte[] { 0x2a, 0x38, 0x44, 0x34, 0x38, 0x35, 0x30, 0x32, 0x30, 0x39, 0x39, 0x34, 0x34, 0x30, 0x39, 0x39, 0x34, 0x30, 0x38, 0x33, 0x38, 0x31, 0x37, 0x35, 0x42, 0x32, 0x38, 0x34, 0x46, 0x3b };
                        await stream.WriteAsync(bytestosendDF17TypeCode19ST1, 0, bytestosendDF17TypeCode19ST1.Length);

                        Thread.Sleep(2000);

                        byte[] bytestosendDF17TypeCode19ST3 = new byte[] { 0x2a, 0x38, 0x44, 0x41, 0x30, 0x35, 0x46, 0x32, 0x31, 0x39, 0x42, 0x30, 0x36, 0x42, 0x36, 0x41, 0x46, 0x31, 0x38, 0x39, 0x34, 0x30, 0x30, 0x43, 0x42, 0x43, 0x33, 0x33, 0x46, 0x3b };
                        await stream.WriteAsync(bytestosendDF17TypeCode19ST3, 0, bytestosendDF17TypeCode19ST3.Length);
